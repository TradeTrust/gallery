...
const loadDocuments = async () => {
  const filenames = {
    ...
    coo_redacted: 'w3c/v2_0/certificate-of-origin-redacted.json',
    coo_revoked: 'w3c/v2_0/certificate-of-origin-revoked.json',
    coo_expired: 'w3c/v2_0/certificate-of-origin-expired.json',
    epn_operative: 'w3c/v2_0/electronic-promissory-note-operative.json',
    epn_inoperative: 'w3c/v2_0/electronic-promissory-note-inoperative.json',
    bol_operative: 'w3c/v2_0/bill-of-lading-operative.json',
    bol_inoperative: 'w3c/v2_0/bill-of-lading-inoperative.json',
    inv_default: 'w3c/v2_0/invoice-default.json',
    inv_redacted: 'w3c/v2_0/invoice-redacted.json',
    inv_revoked: 'w3c/v2_0/invoice-revoked.json',
    inv_expired: 'w3c/v2_0/invoice-expired.json',
    whr_operative: 'w3c/v2_0/warehouse-receipt-operative.json',
    whr_inoperative: 'w3c/v2_0/warehouse-receipt-inoperative.json',
